...
Write a function named removeThree that takes an index and an array. The function should removes three items in the 
array starting with the value at the index. 
------------------------------------------------------------------------------------------------ */
...
const listFoods = (recipe) => {
  let result = [];
  // Solution code here...
  for (let index = 0; index < gruffaloCrumble.ingredients.length; index++) {

    let indx=gruffaloCrumble.ingredients[index].indexOf(' ');
    gruffaloCrumble.ingredients[index]=gruffaloCrumble.ingredients[index].slice(indx+1);
    let indx2=gruffaloCrumble.ingredients[index].indexOf(' ');
    gruffaloCrumble.ingredients[index]=gruffaloCrumble.ingredients[index].slice(indx2+1);
  
    result.push(gruffaloCrumble.ingredients[index]);
  }
  return result;
};
